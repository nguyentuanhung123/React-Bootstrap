        ...
        <div className="bg-dark d-flex flex-column justify-content-between min-vh-100">
            <div className="mt-2">
                ...
                >
                    ...
                    <li className="nav-item my-1 py-2 py-sm-0">
                        <Link to="/house" className="nav-link text-white text-center text-sm-start" aria-current="page">
                            <i className="bi bi-house"></i>
                            <span className="ms-2 d-none d-sm-inline">House</span>
                        </Link>
                    </li>
                    <li className="nav-item my-1 py-2 py-sm-0">
                        <Link to="/customers" className="nav-link text-white text-center text-sm-start" aria-current="page">
